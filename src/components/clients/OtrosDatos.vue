...
export default {
  ...
  setup() {
    ...
    const otrosdatos = ref({id: 0, client_id: route.params.id, zone: 0, user_id: 0, client_cxc: 0, type_client: 0, type_price: 0});
    
    const formulario = async () => {
      if (nuevo.value && otrosdatos.value.client_id !== "") {
        console.log('guardamos si existe el cliente');
        await axios
    ...
    return { clients, zones, formulario, loading, nuevo, otrosdatos, sellers, textinsertupdate };
  },
};
</script>
