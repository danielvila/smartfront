        ...
        <table class="min-w-full">
          <thead class="border-b text-white">
            <tr class="bg-teal-400">
              ...
              <th scope="col" class="text-sm font-medium p-3 text-left">Nro. compra</th>
              <th scope="col" class="text-sm font-medium p-3 text-left">Compras contado</th>
              <th scope="col" class="text-sm font-medium p-3 text-left">Compras cr&eacute;dito</th>
              <th scope="col" class="text-sm font-medium p-3 text-left">Total compra</th>
